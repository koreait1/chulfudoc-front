...
const FindPwForm = ({ errors, form, onChange, onCallback, pending, setPending }) => {
  return (
     <StyledForm autoComplete="off">
      ...
      <AuthNumButton data={'userId='+ form.userId + "&email=" + form.email} apiUrl={ApiUrl.PWRESET} callback={onCallback} onRequestStart={() => setPending(true)} >
        임시 비밀번호 보내기
      </AuthNumButton>
